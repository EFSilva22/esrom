function valider(){
  ...
  if(!user.value){
      alertWifi("Usuário em branco! Favor preenchê-lo",  false, 0, "../img/alerta.gif", 30);
      nome.focus();
      
  }else if (!pwd.value){
      alertWifi("Senha em branco! Favor preenchê-la",  false, 0, "../img/alerta.gif", 30);
      senha.focus();
  }else{
...
function checkUser(content, usuario, senha) {
  ...
  if (achou)
  alertWifi("Login válido. Uhuull!" , false, 0, "../img/alerta.gif", 30);
  else
      alertWifi("Usuário inválido!", false, 0, "../img/alerta.gif", 30);
}